...
def analyze_robustness():
    clean_csv = "/scratch/results/mami_clean_predictions.csv"
    obs_csv = "/scratch/results/mami_obfuscated_predictions_80.csv"
    ...
    print("\n" + "="*50)
    print("MAMI ROBUSTNESS ANALYSIS REPORT")
    print("="*50)
